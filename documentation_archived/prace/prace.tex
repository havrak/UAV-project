...
\def\AbstraktEN{%
The aim of the work is to create an unmanned aerial vehicle system which will be controled remotely by the pilot from software on a computer.
Pilot should recive all the necessary telemetry in addition to video stream from the aircraft.
...
Pro zpracování je použita knihovna inih\footnote{\bibentry{inih}}.
...
V případě senzoru INA226 bylo forknuto demo\footnote{\bibentry{INA226L}} z GitHubu a dopsáno v plnohodnotnou knihovnu.
...
Původní verze knihovny\footnote{\bibentry{PCA9865}} využívala driver bcm2835 ke komunikaci s I2C linkou.
...
Kvůli absenci předešlých zkušeností s Gtk toolkitem a nástrojem glade na vytváření uživatelského prostředí byla použita boilerplate aplikace\footnote{\bibentry{BoilerplateGUI}}.
...
Samotné textury pro umělý horizont byly převzaty z jiného projektu\footnote{\bibentry{Texture}}.
