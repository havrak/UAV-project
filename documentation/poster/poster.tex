  ...
  \begin{columns}[t]
    ...
    \begin{column}{\colwidth}
      ...
      \begin{block}{Použité technologie}
        ...
        \begin{figure}
          \subfigure{\includegraphics[width=5cm]{./index1.png}}
          \hfill
          \subfigure{\includegraphics[width=6cm]{./index2.png}}
          \hfill
          \subfigure{\includegraphics[width=5cm]{./index3.png}}
          \hfill
          \subfigure{\includegraphics[width=5cm]{./index4.png}}
          \hfill
          \subfigure{\includegraphics[width=5cm]{./index5.jpg}}
          \hfill
      ...
      \begin{block}{Fotografie letadla}
				...
				\begin{figure}[h]
					\centering
					\includegraphics[height=19cm]{./whole_plane.jpg}
				\end{figure}
